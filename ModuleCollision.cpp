...
ModuleCollision::ModuleCollision(Application* app, bool start_enabled) : Module(app, start_enabled)
{
	...
	matrix[COLLIDER_WALL][COLLIDER_FALSE_WALL] = false;
	matrix[COLLIDER_WALL][COLLIDER_BOMB_EXPLOSION] = true;
	matrix[COLLIDER_WALL][COLLIDER_PLAYER_BOMB] = true;

	matrix[COLLIDER_PLAYER][COLLIDER_WALL] = true;
	matrix[COLLIDER_PLAYER][COLLIDER_PLAYER] = false;
	matrix[COLLIDER_PLAYER][COLLIDER_ENEMY] = true;
	matrix[COLLIDER_PLAYER][COLLIDER_FALSE_WALL] = true;
	matrix[COLLIDER_PLAYER][COLLIDER_BOMB_EXPLOSION] = false;
	matrix[COLLIDER_PLAYER][COLLIDER_PLAYER_BOMB] = false;

	matrix[COLLIDER_ENEMY][COLLIDER_WALL] = true;
	matrix[COLLIDER_ENEMY][COLLIDER_PLAYER] = true;
	matrix[COLLIDER_ENEMY][COLLIDER_ENEMY] = false;
	matrix[COLLIDER_ENEMY][COLLIDER_FALSE_WALL] = true;
	matrix[COLLIDER_ENEMY][COLLIDER_BOMB_EXPLOSION] = false;
	matrix[COLLIDER_ENEMY][COLLIDER_PLAYER_BOMB] = true;

	matrix[COLLIDER_FALSE_WALL][COLLIDER_WALL] = true;
	matrix[COLLIDER_FALSE_WALL][COLLIDER_PLAYER] = false;
	matrix[COLLIDER_FALSE_WALL][COLLIDER_ENEMY] = true;
	matrix[COLLIDER_FALSE_WALL][COLLIDER_FALSE_WALL] = false;
	matrix[COLLIDER_FALSE_WALL][COLLIDER_BOMB_EXPLOSION] = false;
	matrix[COLLIDER_FALSE_WALL][COLLIDER_PLAYER_BOMB] = false;

	matrix[COLLIDER_BOMB_EXPLOSION][COLLIDER_WALL] = true;
	matrix[COLLIDER_BOMB_EXPLOSION][COLLIDER_PLAYER] = false;
	matrix[COLLIDER_BOMB_EXPLOSION][COLLIDER_ENEMY] = false;
	matrix[COLLIDER_BOMB_EXPLOSION][COLLIDER_FALSE_WALL] = false;
	matrix[COLLIDER_BOMB_EXPLOSION][COLLIDER_BOMB_EXPLOSION] = false;
	matrix[COLLIDER_BOMB_EXPLOSION][COLLIDER_PLAYER_BOMB] = false;
	...
	matrix[COLLIDER_PLAYER_BOMB][COLLIDER_FALSE_WALL] = true;
	matrix[COLLIDER_PLAYER_BOMB][COLLIDER_BOMB_EXPLOSION] = false;
